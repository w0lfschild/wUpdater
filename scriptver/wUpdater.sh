...
{
	echo -n ""
	#"$scriptDirectory"/trash.sh "$oldDirectory"
...
update_confimed() 
{
	...
	open -a /tmp/"$applicationName".app/Contents/Resources/wUpdater.app/Contents/MacOS/wUpdater i "$oldDirectory"
}
...
cocoaDirectory="$scriptDirectory"/CocoaDialog.app/Contents/MacOS/CocoaDialog
